...
namespace OpcUaTest
{
    ...
    public partial class WorkOrder : ComplexObject
    {
        ...
        // {
        //     //base.Decode(decoder);
        //     EncodingFactory.Encoding.Read(decoder,ref Id, nameof(Id));
        //     EncodingFactory.Encoding.Read(decoder,ref AssetId, nameof(AssetId));
        //     EncodingFactory.Encoding.Read(decoder,ref StartTime, nameof(StartTime));
        //     EncodingFactory.Encoding.Read(decoder,ref StatusComments, nameof(StatusComments));
        // }
        //
